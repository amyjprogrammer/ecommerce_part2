...
SECRET_KEY = '*k3j7r#5y_goyw9%36@#3-&u*g$q*xg5&m79b$5t*+ww9wktkp'
...
#in live production use AWS S3 + Cloudfront, Google Cloud Storage, django-storages or whitenoise
STATIC_ROOT = BASE_DIR / "cdn_test"/ "static"

MEDIA_URL = "/media/"

#file field for uploads
